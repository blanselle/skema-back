...
class BacPersister implements ContextAwareDataPersisterInterface
{
    ...
    public function persist($data, array $context = []): object
    {
        ...
        $medias = $this->mediaRepository->findOrphanBacMedia($currentUser->getStudent());
