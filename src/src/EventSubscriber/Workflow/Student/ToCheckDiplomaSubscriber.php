...
class ToCheckDiplomaSubscriber implements EventSubscriberInterface
{
    ...
    public function toCheckDiploma(TransitionEvent $event): void
    {
        ...
        $this->notificationCenter->dispatch(
            $this->notificationManager->createNotification(
                ...
                blocKey: NotificationExemptionMessageConstants::NOTIFICATION_CHECK_DIPLOMA,
