...
class DayTimeFieldNotNullValidator extends ConstraintValidator
{
    public function validate(mixed $value, Constraint $constraint)
    {
        if (!$constraint instanceof DayTimeFieldNotNull) {
            throw new UnexpectedTypeException($constraint, DayTimeFieldNotNull::class);
        }
